...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query->rowCount() == 0) {
            $con = "INSERT INTO admin(UserName,email,Password,user_type) VALUE(:username,:email,:password,:user_type)";
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel">
                                        ...
                                        <div class="panel-body"> 
                                            ...
                                            <form name="chngpwd" method="post" \ onSubmit="return valid();" id="myForm">
